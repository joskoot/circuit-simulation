...
whereas in other documents level triggered bistable multivibrators may be called ‘latches’.
...
causing the D-flip-flop to oscillate:
...
@Interaction*[
 (define (test-D-flip-flop constr #:tabulate? (tabulate? #f))
   ...
   (code:comment " ")
   (parameterize ((current-agenda (agenda-make 'test-agenda)))
     (code:comment " ")
     (define in-wire (wire-make 'in))
